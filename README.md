...
[![npm version](https://img.shields.io/npm/v/date-core.svg)](https://www.npmjs.com/package/date-core)
...
We welcome contributions! Please visit our [GitHub repository](https://github.com/date-core/date-core) for contribution guidelines.

## 📄 License

This project is licensed under the MIT License - see the [LICENSE file](https://github.com/date-core/date-core/blob/main/LICENSE) for details.
